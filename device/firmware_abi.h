...
#ifndef USB_9588_FIRMWARE_ABI_H
#define USB_9588_FIRMWARE_ABI_H

/*
 * Reconstructed firmware ABI used by the JZ4730 transport implementation.
 * Entries may be firmware-specific and are not a stable public BDA SDK.
 */
...
/*
 * Raw session descriptors remain for historical probe branches. Live PCM
 * capture addresses and guards are provided only by the SDK bda_audio.h API.
 */
 ...
 * GUI smoke；动态验证范围和复现步骤见 docs/verified/msgbox_api.md。
 */
